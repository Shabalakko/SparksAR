...
public class IstantiateAudioAtPosition : MonoBehaviour
{
    ...
    {
        // Controlla se l'oggetto ・gi・stato distrutto.
        if (destroyedObjectIds.Contains(instantiatingObjectId))
        {
            yield break; // Se ・gi・stato distrutto, esci dalla Coroutine.
        }
        ...
        if (audioPrefab != null)
        {
            ...
            else
            {
                ...
                // Se non c'・AudioSource o clip, distruggi l'oggetto dopo un breve ritardo di sicurezza
